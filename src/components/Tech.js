...
function Tech(props) {
    return (
        <div class="bg-white dark:bg-gray-800 ">
            ...
            <div className='grid gap-4 place-content-center justify-items-center grid-cols-3 grid-flow-row gap-4 dark:bg-gray-800 px-6'>
                {
                            ...
                            <div class=" flex-row gap-4 flex justify-center items-center">
                                <div class="flex-shrink-0 ">
                                    <a href="#" class="block relative">
                                        <img alt={tech.name} src={tech.image} class="mx-auto object-cover rounded-full h-14 w-14 "/>
                                    </a>
                                </div>
